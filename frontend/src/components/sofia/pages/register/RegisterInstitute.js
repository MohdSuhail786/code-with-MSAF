...
import { signupInstitute } from "../../../student/Signup/store/action/index.js";
import AppContext from "../../../../context/AppContext.jsx";

const RegisterInstitute = (props) => {
  const [state, setState] = useState({ name:'', email: '', password: '',collegeName:''} )
          ...
          <Col xs={12} lg={6} className="left-column">
            <Widget className="widget-auth widget-p-lg">
              ...
              <FormGroup className="my-3">
                ...
                <FormGroup className="my-3">
                  <FormText>Institute Name</FormText>
                  <Input
                    id="name"
                    className="input-transparent pl-3"
                ...
                <Link to="/signup">Register as Student</Link>
              </form>
            </Widget>
          </Col>
