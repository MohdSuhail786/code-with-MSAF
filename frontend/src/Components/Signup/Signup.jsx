      ...
      <div className="right-container">
        <div className="signup-form">
          ...
          <div className="field">
            ...
            <input placeholder="User Name" type="text"  style={{border:"2px solid whiteSmoke"}}></input><br />
       
          </div>
          <div className="field">
            <label>Email*</label>
            <input placeholder="Email" type="email" onChange={(e)=>validateEmail(e) } style={emailError?{border:"2px solid red"}:{border:"2px solid green"}}></input><br />
